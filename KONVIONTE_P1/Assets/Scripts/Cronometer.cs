...
public class Cronometer : MonoBehaviour
{
    ...
    /// <summary>
    /// Este m?todo se encarga de ir aumentando el tiempo del cron?metro
    /// </summary>
    void GrowTime()
    {
    ...
    /// <summary>
    /// Este m?todo se encarga de parar el tiempo del cron?metro cuando este haya matado al jugador o cuando 
    /// </summary>
